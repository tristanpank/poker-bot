...
export default function DealHoleCards({ botPosition, holeCards, players, playerNames, canUndo, onUndo, children }: DealHoleCardsProps) {
    return (
        <div className="flex-1 flex flex-col gap-2 p-3">
            <div className="text-center animate-slide-up" style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}>
                ...
                <p className="text-[var(--color-text-secondary)] text-[10px]">Bot position: {getTablePosition(botPosition, players.length)}</p>
            </div>

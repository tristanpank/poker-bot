...
POSITION_NAMES_V24 = ("SB", "BB", "UTG", "MP", "CO", "BTN")
...
def _semantic_action_to_policy(
    ...
    if semantic_action == "open_raise":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_SMALL,))
    elif semantic_action == "open_raise_big":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_LARGE, ACTION_AGGRO_SMALL))
    elif semantic_action == "isolate":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_SMALL,))
    elif semantic_action == "isolate_big":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_LARGE, ACTION_AGGRO_SMALL))
    elif semantic_action == "three_bet_ip":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_SMALL, ACTION_AGGRO_LARGE))
    elif semantic_action == "three_bet_oop":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_LARGE, ACTION_AGGRO_SMALL))
    elif semantic_action == "four_bet":
        preferred_raise = _first_legal_raise(legal_mask, (ACTION_AGGRO_LARGE, ACTION_AGGRO_SMALL))
    elif semantic_action == "jam":
        if policy.shape[0] > ACTION_AGGRO_LARGE:
            policy[ACTION_AGGRO_LARGE] = 1.0
